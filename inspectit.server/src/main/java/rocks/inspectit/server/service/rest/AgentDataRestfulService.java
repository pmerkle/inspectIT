...
public class AgentDataRestfulService {
	...
	@ResponseBody
	public PlatformIdent getAgentComplete(@RequestParam(value = "platformId", required = true) long platformId) throws BusinessException {
		return globalDataAccessService.getCompleteAgent(platformId);
	}
